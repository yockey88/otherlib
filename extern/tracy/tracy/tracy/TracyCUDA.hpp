...
namespace tracy {
  ...
  #define GET_STREAM_FUNC(Params, field) [](CUpti_CallbackData* api) { \
    return ((Params*)api->functionParams)->field;                      \
  }
  #define NON_STREAM_FUNC() [](CUpti_CallbackData*) { \
