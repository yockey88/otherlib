...
namespace other {
  ...
  class mock_rendering_api : public rendering_api {
   public:
    ...
    MOCK_METHOD(void, upload_texture, (const resource_handle& handle, texture::tex_type type, texture::format format, const glm::ivec2& img_size, uint32_t depth, void* data, size_t data_size), (override));
