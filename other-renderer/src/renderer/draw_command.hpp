...
namespace other {
  ...
  /// which half of the draw-list partition a scene pass consumes (opaque feeds gbuffer/shadow/voxelize,
  ///  transparent only the blended forward pass); k-prefixed because wingdi.h claims OPAQUE/TRANSPARENT
