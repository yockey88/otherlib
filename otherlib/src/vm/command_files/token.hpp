...
namespace other {
  ...
  constexpr inline std::array<keyword_token, kNumKwTokens> kKeywordTokens = {
    ...
    keyword_token("dumpx", TOKEN_TYPE_KW_DUMPX),
    keyword_token("dumpmem", TOKEN_TYPE_KW_DUMPMEM),
    keyword_token("write", TOKEN_TYPE_KW_WRITE),
    keyword_token("load", TOKEN_TYPE_KW_LOAD),
    keyword_token("set", TOKEN_TYPE_KW_SET),
    keyword_token("iwrite", TOKEN_TYPE_KW_IWRITE),
    ...
    keyword_token("retx", TOKEN_TYPE_KW_RETX),
