/**
 * \file ui/console/console.cpp
 **/
#include "ui/console/console.hpp"

#include "ui/console/console_history_node.hpp"
...
namespace other {
  namespace ui {
    ...
    console_window::console_window(event_system& events, driver* driver)
      ...
      history_node_id = add_node(make_ref<console_history_node>(this, driver));
      input_node_id = add_node(make_ref<console_input_node>(this, driver));
    }
