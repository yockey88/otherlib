/**
 * \file ui/asset_browser_grid_node.hpp
 **/
  ...
  namespace ui {
    ...
    class asset_browser_grid_node : public ui_node {
     public:
      ...
      inline const std::vector<abw::asset_card_desc>& get_assets() const { return assets; }
     ...
     private:
      ...
      std::vector<abw::breadcrumb_segment> breadcrumbs;

      /// search / filter
      char search_buf[256] = {};
      std::string search_lower;

      std::vector<abw::filter_pill_desc> filters;
      std::vector<abw::asset_card_desc> assets;
